...
from domains.training.lora import apply_lora_to_model, LoRAConfig, LoRATrainer
...
class SloughGPTTrainer:
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            print(f"Epoch {epoch+1} | Train: {train_loss/steps_per_epoch:.4f} | Val: {val_loss/10:.4f}")
