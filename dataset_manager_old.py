#!/usr/bin/env python3
"""
Dataset Registry and Manager for SloGPT
...
class DatasetInfo:
    ...
    def __init__(self, name: str, path: Path, meta: Optional[Dict[str, Any]] = None):
        ...
        self.path = path
        self.meta = meta or {}
        self.vocab_size = meta.get('vocab_size', 0) if meta else 0
        self.train_tokens = meta.get('train_tokens', 0) if meta else 0
        self.val_tokens = meta.get('val_tokens', 0) if meta else 0
        self.total_characters = meta.get('total_characters', 0) if meta else 0
        self.source_files = meta.get('source_files', []) if meta else []
...
class MultiDatasetMixer:
    ...
    def create_mixed_dataset(self, 
                           ...
                           output_name: str,
                           output_dir: str = None) -> DatasetInfo:
...
class DatasetManager:
    ...
    def mix(self, config_file: str = None, ratios: str = None, output: str = "mixed_dataset"):
