...
RECOVERED_FILES = {
    ...
    "web_interface.py": {"description": "Web UI", "location": "apps/web/"},
    "simple_webui.py": {"description": "Simple WebUI", "location": "apps/web/"},
    "enhanced_webui.py": {"description": "Enhanced WebUI", "location": "apps/web/"},
    ...
    "chat.py": {"description": "Chat UI routes", "location": "apps/web/app/(app)/chat/"},
    "build_webui.py": {"description": "WebUI build", "location": "apps/web/package.json (npm run build)"},
    "launch_webui.py": {"description": "WebUI dev server", "location": "apps/web (npm run dev)"},
}
